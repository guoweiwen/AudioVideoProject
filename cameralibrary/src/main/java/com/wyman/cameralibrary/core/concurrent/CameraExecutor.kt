package com.wyman.cameralibrary.core.concurrent
...
class CameraExecutor(
     ...
     * */
    fun<T> execute(operation : com.wyman.cameralibrary.core.concurrent.CameraExecutor.Operation<T>) : Future<T>{
    ...
    data class Operation<out T>(
        val cancellabel : Boolean = false,//默认都是不撤销
