...
import com.wyman.cameralibrary.core.listener.OnCameraCallback
import com.wyman.cameralibrary.core.listener.OnCaptureListener
import com.wyman.cameralibrary.core.listener.OnFpsListener
import com.wyman.cameralibrary.listener.OnGallerySelectedListener
import com.wyman.cameralibrary.listener.OnMusicSelectListener
import com.wyman.cameralibrary.listener.OnPreviewCaptureListener
import com.wyman.cameralibrary.model.AspectRatio
import com.wyman.cameralibrary.model.GalleryType
import com.wyman.filterlibrary.beauty.bean.BeautyParam
...
class CameraParam private constructor(){
    ...
    // 当前长宽比
    var currentRatio : Float = com.wyman.cameralibrary.core.camera.CameraParam.Companion.Ratio_16_9
    // 期望帧率
    var expectFps : Int = com.wyman.cameralibrary.core.camera.CameraParam.Companion.DESIRED_PREVIEW_FPS
    // 实际帧率
    ...
    // 录制时长(ms)
    var recordTime : Int = com.wyman.cameralibrary.core.camera.CameraParam.Companion.DEFAULT_RECORD_TIME
    // 录音权限
    ...
    companion object{
        ...
        //单例设计
        val INSTANCE = com.wyman.cameralibrary.core.camera.CameraParam()
    }
    ...
    private fun reset(){
        ...
        currentRatio = com.wyman.cameralibrary.core.camera.CameraParam.Companion.Ratio_16_9
        expectFps = com.wyman.cameralibrary.core.camera.CameraParam.Companion.DESIRED_PREVIEW_FPS
        previewFps = 0
        expectWidth = com.wyman.cameralibrary.core.camera.CameraParam.Companion.DEFAULT_16_9_WIDTH
        expectHeight = com.wyman.cameralibrary.core.camera.CameraParam.Companion.DEFAULT_16_9_HEIGHT
        previewWidth = 0
        previewHeight = 0
        ...
        focusWeight = 1000
        recordable = true
        recordTime = com.wyman.cameralibrary.core.camera.CameraParam.Companion.DEFAULT_RECORD_TIME
