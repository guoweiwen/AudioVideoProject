package com.wyman.cameralibrary.render
...
import com.wyman.cameralibrary.model.ScaleType
import com.wyman.filterlibrary.beauty.bean.IBeautify
import com.wyman.filterlibrary.glfilter.GLImageFilter
import com.wyman.filterlibrary.glfilter.GLImageOESInputFilter
import com.wyman.filterlibrary.glfilter.makeup.bean.DynamicMakeup
...
class RenderManager private constructor() {
    ...
    // 相机参数
    private val mCameraParam: com.wyman.cameralibrary.core.camera.CameraParam
    // 上下文
    ...
    init {
        mCameraParam = com.wyman.cameralibrary.core.camera.CameraParam.INSTANCE
    }
