package com.wyman.fakedouyin.presenter
...
//    }
    ...
    fun onBindSurfaceTexture(surfaceTexture: SurfaceTexture?) {
        com.wyman.cameralibrary.core.camera.CameraEngine.setPreviewSurface(surfaceTexture!!)
...
//        mActivity!!.deleteProgressSegment()
    ...
    private fun openCamera() {
        releaseCamera()
        com.wyman.cameralibrary.core.camera.CameraParam.INSTANCE.backCamera = true
        Log.e(TAG,"openCamera")
        com.wyman.cameralibrary.core.camera.CameraEngine.openCamera(mActivity!!)
        calculateImageSize()
        com.wyman.cameralibrary.core.camera.CameraEngine.startPreview()
    ...
    private fun calculateImageSize() {
        val width: Int
        val height: Int
        if (com.wyman.cameralibrary.core.camera.CameraParam.INSTANCE.orientation === 90 || com.wyman.cameralibrary.core.camera.CameraParam.INSTANCE.orientation === 270) {
            width = com.wyman.cameralibrary.core.camera.CameraParam.INSTANCE.previewHeight
            height = com.wyman.cameralibrary.core.camera.CameraParam.INSTANCE.previewWidth
        } else {
            width = com.wyman.cameralibrary.core.camera.CameraParam.INSTANCE.previewWidth
            height = com.wyman.cameralibrary.core.camera.CameraParam.INSTANCE.previewHeight
        }
...
//        mActivity!!.updateTextureSize(width, height)
    ...
    private fun releaseCamera() {
        com.wyman.cameralibrary.core.camera.CameraEngine.releaseCamera()
    }
